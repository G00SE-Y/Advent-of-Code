...
int main(int argc, char* argv[]) {
    ...
    if(argc != 3) {
        std::cout << "Please enter input in the form `./scratchcard.exe [ \"p1\" | \"p2\" ] <*.txt>`" << std::endl;
        return 0;
    }
